...
flowchart TB
    ...
    HybridDispatch -->|"registry (80 tools)"| ToolRegistry
...
flowchart TD
    ...
    DispatchCall["dispatch_inner — ToolRegistry lookup (80 tools)"]
