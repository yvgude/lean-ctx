...
[Website](https://leanctx.com) · [Install](#installation) · [Quick Start](#quick-start) · [CLI Reference](#cli-commands) · [MCP Tools](#9-mcp-tools) · [TDD](#token-dense-dialect-tdd) · [Dashboard](#persistent-stats--web-dashboard) · [Editor Setup](#editor-configuration) · [vs RTK](#lean-ctx-vs-rtk) · [Discord](https://discord.gg/pTHkG9Hew9)
