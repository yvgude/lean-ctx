...
> **Latest version: 3.7.5** — 72 MCP tools · 10 read modes · 95+ shell patterns
...
2. **MCP Server** — 72 tools for cached file reads, 10 read modes, deltas, dedup, memory, multi-agent coordination, and more
...
**Q: Where can I find docs for all 72 tools?**
...
- **Full (default)**: All 72 tools available as separate `ctx_*` tools
