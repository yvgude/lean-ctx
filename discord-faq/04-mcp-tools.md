...
lean-ctx splits its 72 tools into 6 categories. In supporting IDEs, only the **core** category is loaded by default — additional categories are loaded on demand:
