...
For agents without direct shell access. All 77 tools available via MCP protocol.
...
Every agent gets access to the same 77 MCP tools. The most important ones:
