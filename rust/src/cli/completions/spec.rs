...
pub static COMMAND_TREE: &[CommandNode] = &[
    ...
    CommandNode {
        ...
        subcommands: &[CommandNode {
            name: "speed",
            aliases: &[],
            description: "Signed A/B proof: model latency with and without lean-ctx context",
            subcommands: &[],
            flags: &[
                FlagSpec {
                    long: "--suite",
                    short: None,
                    description: "Eval suite (lean-ctx eval init <dir>)",
                    takes_value: true,
                    value_kind: None,
                },
                FlagSpec {
                    long: "--runs",
                    short: None,
                    description: "Timed runs per task and arm (default 3)",
                    takes_value: true,
                    value_kind: None,
                },
                FlagSpec {
                    long: "--budget",
                    short: None,
                    description: "lean-ctx context budget in tokens",
                    takes_value: true,
                    value_kind: None,
                },
                FlagSpec {
                    long: "--out",
                    short: None,
                    description: "Write the signed proof to this file",
                    takes_value: true,
                    value_kind: None,
                },
                FlagSpec {
                    long: "--json",
                    short: None,
                    description: "Print the proof as JSON",
                    takes_value: false,
                    value_kind: None,
                },
                FlagSpec {
                    long: "--verify",
                    short: None,
                    description: "Verify a proof file (default: the latest)",
                    takes_value: false,
                    value_kind: None,
                },
            ],
    ...
    CommandNode {
        ...
        flags: &[
            ...
            FlagSpec {
                long: "--json",
                short: None,
                description: "Segment and labelled breakdown as JSON (editor status bars)",
                takes_value: false,
                value_kind: None,
            },
            FlagSpec {
