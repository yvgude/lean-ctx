...
(function () {
  ...
  var TIPS = {
    ...
    compression_rate: 'Net savings rate: verified savings \u00f7 all tool-call input tokens (includes non-compressible operations like terminal polling and meta-tools).',
