...
pub fn run() {
    ...
    // Session cache health (#361): CEP sessions + the cross-call hit ratio
    // come from the persistent stats store.
    ...
    println!(
        "  {BOLD}Session cache{RST}  {WHITE}{} sessions{RST}  {DIM}{}/{} reads cached ({hit_ratio:.0}% hit){RST}",
